...
<head>
    ...
    <title>Prodavnica-online sistem za trgovinu organskom hranom</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>Naša prodavnica</h1>
            <p>Dobrodošli na online sistem za trgovinu organskom hranom-
                </br>Vašeg pouzdanog partnera za zdrav i prirodan način života.
             </p>
            <a href="index.php">POČETNA</a><span>/ PRODAVNICA</span>
        </div>
    </div>
    <div class="line"></div>
    <!-----------------------about us------------------------>
    <section class="shop">
        <h1 class="title">KUPUJ PO NAJBOLJIM CIJENAMA</h1>
