...
<head>
    ...
    <title>Lista želja -online sistem za trgovinu organskom hranom</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <p></p>
            <a href="index.php">Početna</a><span>/ Lista želja</span>
        </div>
    </div>
    <div class="line"></div>
    <!-----------------------about us------------------------>
    <section class="shop">
        <h1 class="title">PROIZVODI DODATI NA LISTU ŽELJA</h1>
        ...
        ?>
            ...
            <form method="post" class="box">
                ...
                <div class="price"><?php echo $fetch_wishlist['price']; ?>KM/-</div>
                ...
                <div class="icon">
                    ...
                    <a href="wishlist.php?delete=<?php echo $fetch_wishlist['id']; ?>" class="bi bi-x" onclick="return confirm('Da li želite da izbrišete ovaj proizvod iz liste želja ?')"></a>
        ...
        <div class="wishlist_total">
            ...
            <a href="wishlist.php?delete_all" class="btn <?php echo ($grand_total)?'':'disabled'?>" onclick="return confirm('Da li želiš da izbrišeš sve proizvode iz liste želja ?')">Izbriši sve</a>
        </div>
    </section>
