	...
	if (isset($_POST['add_product'])) {
		...
		if(mysqli_num_rows($select_product_name)>0){
			...
			if ($insert_product) {
				if ($image_size > 2000000) {
					$message[] = 'Veličina slike prevelika';
				}else{
					move_uploaded_file($image_tmp_name, $image_folder);
					$message[] = 'proizvod dodat uspješno';
				}
			}
		}
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $updateQuery = "UPDATE `products` SET id = '$id' WHERE id = '$productId'";
...
<head>
	...
	<title>Admin(proizvodi)- online sistem za trgovinu organskom hranom</title>
</head>
<body>
	...
	<section class="add-products form-container">
		<form method="POST" action="" enctype="multipart/form-data">
			...
			<input type="submit" name="add_product" value="dodaj proizvod" class="btn">
		</form>
	</section>
	<div class="line3"></div>
	<div class="line4"></div>
	<section class="show-products">
		<div class="box-container">
			...
			<div class="box">
				...
				<p>Cijena :<?php echo $fetch_products['price']; ?> KM </p>
				<h4><?php echo $fetch_products['name']; ?></h4>
				<details > <?php echo $fetch_products['product_detail']; ?></details>
				<a href="admin_product.php?edit=<?php echo $fetch_products['id']; ?>" class="edit">Izmjeni</a>
				<a href="admin_product.php?delete=<?php echo $fetch_products['id']; ?>" class="delete" onclick="return confirm('Da li želite obrisati ovaj proizvod');">Obriši</a>
			</div>
			<?php 
					}
				}else{
	...
	<section class="update-container">
		...
		<form method="POST" enctype="multipart/form-data">
			...
			<input type="submit" name="updte_product" value="Izmjeni" class="edit">
			<input type="reset" name="" value="Poništi" class="option-btn btn" id="close-form">
